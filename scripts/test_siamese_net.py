...
if __name__ == '__main__':
    ...
    argparser.add_argument('-i1', '--image1_path', type=str,
                           ...
                           default='/home/dlrv-ss22-face-recognition/workspace/data/person-images/alex/alex_3.jpg')
    argparser.add_argument('-i2', '--image2_path', type=str,
                           help='Path to a target image',
                           default='/home/dlrv-ss22-face-recognition/workspace/data/person-images/divin/divin_3.jpg')
